describe.skip("Login Suite - Hard Coded Data", function () {
  it("Login Test", function () {
    ...
    //Act
    cy.get('input[type="email"]').type("consolelog@gmail.com");
...
describe.skip("Login Suite - Data from external fixture file - And BeforeEach", function () {
  ...
  it("Login Test", function () {
    ...
    cy.get(':nth-child(2) > .inFormField > input').type(userDetails.email);
    cy.get(':nth-child(3) > .inFormField > input').type(userDetails.password);
