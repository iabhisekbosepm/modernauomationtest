...
describe("Working with cy.task()", function() {
  ...
  it.only("Login Test - Task - generateJSONFromExcel", function() {
    ...
    const excelFilePath =
      "C:\\Abhisek\\Consolelog-course\\Automation\\Day2\\cypress\\fixtures\\logindetails.xlsx";
    const sheetName = "login";
    //Act
    // Replace cy.fixture with task to read data from excel and convert that into json
